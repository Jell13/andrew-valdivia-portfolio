    ...
    <div className='w-full h-full md:px-32 px-8 flex justify-center items-center relative'>
      ...
      <div className='w-full h-full flex items-center justify-evenly'>
        ...
        <div className='w-1/3 flex items-center justify-center'>
          <Link href="/" className='w-16 h-16 bg-black hover:bg-blue-700 ease-in duration-300 dark:text-light text-light rounded-full flex items-center justify-center font-bold text-xl border-2 border-white'>AV</Link>
        </div>
